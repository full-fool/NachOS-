...
Machine::LoadPage(int virtualAddr)
{
    ...
    printf("start to write is %d and %d bytes to be written at %d pos in mainMemory\n",
        startToWrite, PageSize, phyPageNum * PageSize );
    diskFile->ReadAt(&(machine->mainMemory[phyPageNum * PageSize]), PageSize, startToWrite); 
